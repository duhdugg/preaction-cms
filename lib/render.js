...
const reactRender = require('../build/static/js/client.cjs.js').render
...
module.exports = {
  renderClient: async (req, res, options = {}) => {
    ...
    if (options.page) {
      options.page.header = await pages.funcs.getFullPageByPath(
        options.page.settings.headerPath ||
          options.page.fallbackSettings.headerPath ||
          '/home/header/',
        1
      )
      options.page.footer = await pages.funcs.getFullPageByPath(
      ...
      pages.funcs.sanitizeContent(options.page)
      pages.funcs.sanitizeContent(options.page.header)
      pages.funcs.sanitizeContent(options.page.footer)
    }
