...
const reactSSR = require('../build/ssr/client.cjs.js').render
const metaSSR = require('../build/ssr/meta.cjs.js').render
...
module.exports = {
  ...
  renderClient: async (req, res, options = {}) => {
    ...
    if (env.socketMode) {
      ...
      bodySnippet = `<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/socket.io-client@${siov}/dist/socket.io.slim.js"></script>`
    }
