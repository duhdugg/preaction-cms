...
/**
 * @memberof pages.model
 * @class
 */
model.Page = db.sequelize.define('page', {
  /**
   * @memberof pages.model.Page
   * @instance
   * @type {string}
   */
...
model.PageBlock = db.sequelize.define('pageblock', {
  /**
   * @memberof pages.model.PageBlock
   * @instance
   * @type {string}
...
model.PageBlockContent = db.sequelize.define('pageblockcontent', {
  /**
   * @memberof pages.model.PageBlockContent
   * @instance
   * @type {string}
   ...
   * @instance
   * @type {string}
   * @description for 'image' content types only
   */
 ...
 * @returns {Promise} `Object` "full" page, meaning blocks and content included
 */
 ...
 * @param {string} path
 * @param {number} depth
 * see pages.funcs.getFullPageById
 * @returns {Promise} `Object` "full" page, meaning blocks and content included
 */
