...
const createDefaultSettings = async () => {
  ...
  await updateSetting('jumboPath')
  await updateSetting('jumboTheme')
  ...
  await updateSetting('maxWidthJumbo')
  await updateSetting('maxWidthJumboContainer')
  ...
  await updateSetting('showJumbo')
  await updateSetting('jumboPosition')
